...
class Profil extends \Profil implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Profil' . "\0" . 'id', '' . "\0" . 'Profil' . "\0" . 'libelle', '' . "\0" . 'Profil' . "\0" . 'utilisateurs'];
        }
    ...
    public function setUtilisateurs($utilisateurs)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUtilisateurs', [$utilisateurs]);
